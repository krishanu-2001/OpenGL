...
void Display_Text(GLfloat x, GLfloat y, GLfloat z, GLfloat s, GLfloat pointSize, GLfloat rotate, string text)
{
	string buffer = text;
	glPushMatrix();
	glTranslatef(x, y, z);
    ...
    float angleX = (x - xOrigin) * 0.001f * 180;
    float angleY = (y - yOrigin) * 0.001f * 180;
    // cout << angleX << " " << angleY << endl;
	// glRotatef(rotate, 0.0, 1.0, 0.0);
	// glRotatef(angleY, 0.0, 1.0, 1.0);
...
void Draw()
{
    ...
    Display_Text(Text1[0][0], Text1[0][1], Text1[0][2], 0.0009, 4, 0, "Good");

    // Printing at back face
    Display_Text(Text2[0][0], Text2[0][1], Text2[0][2], 0.0009, 4, 0, "Morning");
